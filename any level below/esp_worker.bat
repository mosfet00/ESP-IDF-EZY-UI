...
echo.
echo !CYAN! =========================================!RESET!
echo !CYAN!   Select Category!RESET!
echo !CYAN! =========================================!RESET!
echo.
...
echo.
set /p CCHOICE="  Pick a number: "

set CATEGORYDIR=!CDIR_%CCHOICE%!
set CATEGORYNAME=!CNAME_%CCHOICE%!
...
echo.
echo !GREEN!  Category: !CATEGORYNAME!!RESET!

:PROJECTSELECT
echo.
echo !CYAN! =========================================!RESET!
echo !CYAN!   Select Project  !GRAY!(!CATEGORYNAME!)!RESET!
echo !CYAN! =========================================!RESET!
echo.

set PCOUNT=0
for /d %%S in ("!CATEGORYDIR!\*") do (
...
if !PCOUNT!==0 (
    ...
    echo.
    set /p PBACK="  Pick: "
    if "!PBACK!"=="0" goto CATEGORYSELECT
    goto PROJECTSELECT
)
